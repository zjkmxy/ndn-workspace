...
export let rootDoc: DocHandle<DocumentsType>;
export let docChangeHook: ((docs: DocumentsType) => void) | null = null;
...
export function setDocChangeHook(hook: (docs: DocumentsType) => void) {
  docChangeHook = hook
}
